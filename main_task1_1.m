function main_task1_1()
    fprintf("\n=======課題１：そばとその他=======\n");
    % 課題1
    [img_list, img_label] = utils.create_img_list_with_label_new("./soba", 100, "./bgimg", 200);
    ...
    utils.save_classification_results(img_list, img_label, pred_label, "Hist64", "./Result_1-1");

    model = classification.svm_kfold_new_model5(encoded_v_BoF, img_label, "BoF", 5, "rbf");
    [pred_label, score] = predict(model, encoded_v_BoF);
    utils.save_classification_results(img_list, img_label, pred_label, "BoF", "./Result_1-1");
    ...
    utils.save_classification_results(img_list, img_label, pred_label, "VGG16_fc7", "./Result_1-1");
